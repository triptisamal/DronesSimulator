...
data5 = []
with open("petal_numberofbcast_343_0.400000_1.txt", "r") as f:
    for line in f:
        line = line.strip()
...
plt.title('Perturbed Lattice with sd 0.9, Petal Eccentricity = 0.4, source-destination distance ~ 75 feet, 500 iterations, 99 % CI', wrap=True,fontsize=15)
